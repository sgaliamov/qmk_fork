...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        _______,     KC_Q,        KC_W,        KC_E,        KC_R,        KC_T,        _______,     XXXXXXX,             XXXXXXX,     _______,     KC_Y,        KC_U,        KC_I,        KC_O,        KC_P,        KC_RBRC,
        _______,     KC_A,        KC_S,        KC_D,        KC_F,        KC_G,        KC_SLSH,     _______,             _______,     KC_QUOT,     KC_H,        KC_J,        KC_K,        KC_L,        KC_SCLN,     _______,
        _______,     KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,        KC_MINS,     _______,             _______,     KC_EQL,      KC_N,        KC_M,        KC_COMM,     KC_DOT,      KC_LBRC,     _______,
    ...
    [_FN] = LAYOUT(
        ...
        _______,     KC_SCLN,     C(KC_W),     C(KC_B),     C(KC_R),     C(KC_Y),     KC_NUM,      XXXXXXX,             XXXXXXX,     KC_MPLY,     KC_VOLU,     KC_MPRV,     KC_MNXT,     XXXXXXX,     KC_MINS,     KC_EQL,
        ...
        _______,     C(KC_Z),     C(KC_X),     C(KC_C),     C(KC_V),     KC_COMM,     KC_LBRC,     _______,             _______,     KC_RBRC,     KC_DOT,      XXXXXXX,     XXXXXXX,     XXXXXXX,     XXXXXXX,     _______,
