...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        _______,     _______,     KC_W,        KC_E,        KC_R,        KC_T,        _______,     XXXXXXX,             XXXXXXX,     _______,     KC_Y,        KC_U,        KC_I,        KC_O,        _______,     _______,
        _______,     KC_A,        KC_S,        KC_D,        KC_F,        KC_G,        _______,     _______,             _______,     KC_QUOT,     KC_H,        KC_J,        KC_K,        KC_L,        KC_P,        _______,
        _______,     KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,        _______,     _______,             _______,     _______,     KC_N,        KC_M,        KC_COMM,     KC_DOT,      KC_Q,        _______,
    ...
    [_FN] = LAYOUT(
        ...
        KC_PENT,     C(KC_A),     C(KC_S),     C(KC_H),     C(KC_F),     A(KC_V),     KC_PSLS,     _______,             KC_LSCR,     QUOT_SWAP,   KC_VOLU,     ARROW_FAT,   ARROW_THIN,  XXXXXXX,     KC_PAST,     KC_PEQL,
        ...
        _______,     TO(_BASE),   _______,     _______,     _______,     _______,     _______,     _______,             KC_INS,      _______,     _______,     _______,     _______,     _______,     _______,     _______
    )
};
