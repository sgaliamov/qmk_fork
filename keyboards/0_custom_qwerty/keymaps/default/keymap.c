...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        KC_ESC,      KC_F1,       KC_F2,       KC_F3,       KC_F4,       KC_F5,       XXXXXXX,     XXXXXXX,             XXXXXXX,     XXXXXXX,     KC_F8,       KC_F9,       KC_F10,      KC_F11,      KC_F12,      KC_RALT,
        ...
        KC_TAB,      KC_A,        KC_S,        KC_D,        KC_F,        KC_G,        KC_COMM,     KC_HOME,             KC_PSCR,     KC_DOT,      KC_H,        KC_J,        KC_K,        KC_L,        KC_SCLN,     QUOT_SWAP,
        KC_DEL,      KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,        KC_MINS,     KC_END,              KC_INS,      KC_EQL,      KC_N,        KC_M,        KC_SLSH,     KC_UP,       KC_RGHT,     KC_BSPC,
        KC_LALT,     MO(_FN),     KC_APP,      KC_LCMD,     KC_LCTL,     KC_SPC,      KC_LSFT,     KC_ENT,              KC_ENT,      KC_RSFT,     KC_SPC,      KC_RCTL,     KC_LEFT,     KC_DOWN,     KC_PGDN,     KC_PGUP
   ),
